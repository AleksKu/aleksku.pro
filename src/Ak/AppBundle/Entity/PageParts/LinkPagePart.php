 ...
 * LinkPagePart
 *
 * @ORM\Table(name="akapp_link_page_parts")
 * @ORM\Entity
 */
class LinkPagePart extends AbstractPagePart
{
    ...
    {
	return 'AkAppBundle:PageParts:LinkPagePart/view.html.twig';
    }

    /**
     * Get the admin form type.
     *
     * @return \Ak\AppBundle\Form\PageParts\LinkPagePartAdminType
     */
    public function getDefaultAdminType()
    {
	return new \Ak\AppBundle\Form\PageParts\LinkPagePartAdminType();
    }
}
