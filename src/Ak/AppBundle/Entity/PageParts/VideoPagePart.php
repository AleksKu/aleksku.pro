...
/**
 * @ORM\Entity
 * @ORM\Table(name="akapp_video_page_parts")
 */
class VideoPagePart extends AbstractPagePart
{
    ...
    {
	return "AkAppBundle:PageParts/VideoPagePart:view.html.twig";
    }
    ...
    {
	return new \Ak\AppBundle\Form\PageParts\VideoPagePartAdminType();
    }
}
